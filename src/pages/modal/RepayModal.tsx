...
const RepayModal: React.FC<Props> = ({ isOpen, onClose }) => {
          ...
          <Dialog.Positioner>
            <Dialog.Content>
              <Dialog.Header justifyContent="space-between">
                <Dialog.Title fontSize="22px">Repay USDC</Dialog.Title>
              ...
              <Dialog.Body>
                ...
                <Box>
                  ...
                  <Box p="12px" border="1px solid #eaebef" borderRadius="6px">
                    <Flex justifyContent="space-between" gap="5px" mb="10px">
                      <Box w="22%">Remaining debt</Box>
                      <Flex direction="column" textAlign="right">
                        <Flex alignItems="center" gap="3px">
                          <Box>0.5008700 USDC</Box>
                          <Icon size="sm">
                            <CgArrowRight />
                          </Icon>
                          <Box>0.5008700 USDC</Box>
              ...
              <Dialog.Footer>
                <Button disabled={value.trim() === ""} w="100%" fontSize="18px">
                  {value.trim() === "" ? "Enter an amount" : "Repay USDC"}
                </Button>
              </Dialog.Footer>
            </Dialog.Content>
          </Dialog.Positioner>
