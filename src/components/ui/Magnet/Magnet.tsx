...
—
Disables the magnet effect when set to true.
...
""
Optional CSS class name for the outermost wrapper element.

innerClassName
string

""
Optional CSS class name for the moving (inner) element.
